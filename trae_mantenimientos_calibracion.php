...
<table width="100%" class="sui-table">
    <tr>
        <td style="text-align: left"><strong>Criterio de Aceptacion :<strong> <?php echo $result[0]->titulo ?>
        </td>
    </tr>
</table>
<table width="100%" class="sui-table">
...
<div style="display:none; border: 1px solid black; position: fixed; width: 50%; height:80%; margin-top: -400px; background: #FFF; " id="ventana_carga">
    ...
    <form enctype="multipart/form-data" id="formuploadajax" method="post">
        ...
        <input type="hidden" id="tipo" value="3" name="tipo">
        ...
        <h3>Apto</h3>
        <select id="apto" onchange="selector_apto(this.value)" name="apto">
            <option value="S">Si</option>
            <option value="N">No</option>
        </select>
        <br><br>
        <div id="ver_mjs" style="color:red; font-size: 15px; display: none;">Se elevara una solicitud de mantenimiento correctivo cuya descripcion de falla se tomara de la observacion.</div>
        <br><br>
        <input type="submit" class="btn btn-success" value="Guardar"/>
    </form>
    <div id="mensaje"></div>
</div>
<div style="display:none; border: 1px solid black; position: fixed; width: 80%; height:80%; margin-top: -300px; background: #FFF; " id="detalle_mantenimiento"></div>
<script>
    function selector_apto(value){
        //alert(value);
        if(value=='S'){
            $("#ver_mjs").hide();
        }else{
