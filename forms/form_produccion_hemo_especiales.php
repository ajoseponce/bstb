...
<div id="pre-page-content">
    <h1><i class="glyphicon-nameplate_alt themed-color"></i><small>PROCESO DE PRODUCCION DE HEMOCOMPONENTES ESPECIALES</small></h1>
</div>
<div id="page-content">
...
<div class="block-title">
    <h4>Datos Produccion Hemocomponentes Especiales</h4>
</div>
<div class="block-content">
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <select onchange="busca_periodo_produccion_especiales(this.value)" id="periodo" name="periodo" size="1">
    ...
    <div class="form-actions">
        <input id="id_registro" type="hidden" name="id_registro" value="<?php echo ($result)?$result->id_registro:""; ?>">
            <input id="action" type="hidden" name="action" value="guardar_produccion_especiales">
