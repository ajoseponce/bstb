    ...
    <div class="block block-themed block-last">
        <form id="form_datos" method="post" class="form-horizontal"  enctype="multipart/form-data" >
            ...
            <div class="form-actions">
                <input id="action" type="hidden" name="action" value="guardar_cierra_solicitud">
                ...
                <input  type="button" onclick="enviar_form()" class="btn btn-success" value="Cerrar Solicitud"/>
...
<script type="text/javascript">
    ...
    function enviar_form(){
        ...
        if (error==1){
            alert('Cargue una observacion .Gracias');
            return false;
