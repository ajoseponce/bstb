...
<div class="block block-themed block-last">
    <div class="block-title">
        <h4>PROCESO DE CALIFICACION BIOLOGICA ANALITICAS(Subproceso de InmunoHematologia)</h4>
    </div>
    <div class="block-content">
        ...
        <form id="form_datos" method="post" class="form-horizontal" onsubmit="return false;">
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <select onchange="busca_periodo_inmuno_analiticas(this.value)" id="periodo" name="periodo" size="1">
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <input value="<?php echo ($result)?$result->nro_abo_rh_analiticas:""; ?>" id="nro_abo_rh_analiticas"  name="nro_abo_rh_analiticas" onkeypress="return _soloNumeros(event);" class="input-mini" type="text">
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <input value="<?php echo ($result)?$result->rh_negativos:""; ?>" id="rh_negativos"  name="rh_negativos" onkeypress="return _soloNumeros(event);" class="input-mini" type="text">
                    <!--<span class="help-block">Your username must be unique..</span>-->
                </div>
            </div>
            ...
            <div class="form-actions">
                <input id="id_registro" type="hidden" name="id_registro" value="<?php echo ($result)?$result->id_registro:""; ?>">
                    <input id="action" type="hidden" name="action" value="guardar_inmuno_analiticas">
