    ...
    <div class="block block-themed block-last">
        <form id="form_datos" method="post" class="form-horizontal" >
            <div class="block-title">
                <h4>Derivar a Proveedor Solicitud</h4>
            </div>
            <div class="block-content">
                ...
                <div class="control-group">
                    <div class="control-group" id="sector_capa" >
                        <label class="control-label" for="general-text"><strong>Asignado a Proveedor</strong></label>
                        <div class="controls">
                            <input  id="proveedor_derivado"  name="proveedor_derivado" style="width: 500px;"  class="input-large" value="<?php echo (isset($result->proveedor_derivado))?$result->proveedor_derivado:""; ?>" type="text">
                            <input  id="proveedor_derivadoID"  name="proveedor_derivadoID" type="hidden" value="<?php echo (isset($result->proveedor_derivadoID))?$result->proveedor_derivadoID:""; ?>">
                        </div>
                    </div>
                </div>
                <div class="control-group">
                    <div class="control-group" id="sector_capa" >
                        ...
                        <div class="controls">
                            <textarea  id="observacion" style="width: 650px; height: 215px;"  name="observacion"  value=""><?php echo ($result->observacion)?$result->observacion:""; ?> </textarea>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="form-actions">
                <input id="action" type="hidden" name="action" value="guardar_deriva_solicitud">
...
<script type="text/javascript">
    ...
    function enviar_form(){
        var error=0
        if($("#proveedor_derivadoID").val() ==""){
            error=1
        }
        if (error==1){
            alert('Cargue un proveedor .Gracias');
            return false;
    ...
    newSuggest('proveedor_derivado', 'proveedor_derivadoID', 'PV');
