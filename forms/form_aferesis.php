...
<div id="page-content">
    <ul class="breadcrumb" data-spy="affix" data-offset-top="250">
        ...
        <li class="active"><a href="">Aferesis</a></li>
    </ul>
<div class="block block-themed block-last">
    <div class="block-title">
        <h4>Datos Aferesis</h4>
    </div>
    <div class="block-content">
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <select onchange="busca_periodo_aferesis(this.value)" id="periodo" name="periodo" size="1">
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <input value="<?php echo ($result)?$result->aferesis_pacientes:""; ?>" id="aferesis_pacientes"  name="aferesis_pacientes" onkeypress="return _soloNumeros(event);" class="input-mini" type="text">
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <input value="<?php echo ($result)?$result->aferesis_donantes:""; ?>" id="aferesis_donantes"  name="aferesis_donantes" onkeypress="return _soloNumeros(event);" class="input-mini" type="text">
                <input id="id_registro" type="hidden" name="id_registro" value="<?php echo ($result)?$result->id_registro:""; ?>">
                <input id="action" type="hidden" name="action" value="guardar_aferesis">
            </div>
        </div>
