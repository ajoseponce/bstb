...
<div id="pre-page-content">
    <h1><i class="glyphicon-nameplate_alt themed-color"></i><small>PROCESO DE APOYO</small></h1>
</div>
<div id="page-content">
    <ul class="breadcrumb" data-spy="affix" data-offset-top="250">
        ...
        <li class="active"><a href="">Proceso de Apoyo</a></li>
    </ul>
<div class="block block-themed block-last">
    <div class="block-title">
        <h4>Datos Apoyo Insumos</h4>
    </div>
    <div class="block-content">
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <select onchange="busca_periodo_apoyo_insumos(this.value)" id="periodo" name="periodo" size="1">
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <input value="<?php echo ($result)?$result->ref_verificadas:""; ?>" id="ref_verificadas"  name="ref_verificadas" onkeypress="return _soloNumeros(event);" class="input-mini" type="text">
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <input value="<?php echo ($result)?$result->num_ref_faltantes:""; ?>" id="num_ref_faltantes"  name="num_ref_faltantes" onkeypress="return _soloNumeros(event);" class="input-mini" type="text">
                <input id="id_registro" type="hidden" name="id_registro" value="<?php echo ($result)?$result->id_registro:""; ?>">
                <input id="action" type="hidden" name="action" value="guardar_apoyo_insumos">
            </div>
        </div>
