                    ...
                    <div class="control-group" id="sector_capa">
                        ...
                        <div class="controls">
                            <select id="accion" name="accion">
                                <option <?php echo ($result->estado=='R')?"selected":""; ?> value="C">Seleccionar Opcion</option>
                                <option <?php echo ($result->estado=='C')?"selected":""; ?> value="C">Eficaz</option>
                                <option <?php echo ($result->estado=='V')?"selected":""; ?> value="V">No Eficaz</option>
                            </select>
                        </div>
                    </div>
                </div>
                <div class="control-group">
                    ...
                    <div class="controls">
                        <textarea id="observaciones" style="width: 773px; height: 78px;" name="observaciones"
                                  value=""><?php echo ($result->observacion_eficacia) ? $result->observacion_eficacia : ""; ?> </textarea>
                    </div>
                </div>
            </div>

            <div class="form-actions">
                <input id="action" type="hidden" name="action" value="guardar_eficacia_nc">
