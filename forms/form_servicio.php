        ...
        <div class="block-content">
            ...
            <form id="form_datos" method="post" class="form-horizontal">
                ...
                <div class="form-actions">
                    <input id="id_servicio" type="hidden" name="id_servicio"
                           value="<?php echo (isset($result->id_servicio)) ? $result->id_servicio : ""; ?>">
                    <input id="action" type="hidden" name="action" value="guardar_servicio">
                    <button type="reset" onclick="location.href='controlador.php?action=listar_servicios'"
                            class="btn btn-danger"><i class="icon-repeat"></i> Volver
                    </button>
                    <button onclick="save_datos_servicios()" type="button" class="btn btn-success"><i
                            class="icon-ok"></i> Guardar servicio
                    </button>
                </div>
            </form>
        </div>
