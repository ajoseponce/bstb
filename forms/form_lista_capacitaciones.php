...
<div id="page-content" >
<div class="clearfix">
    <button onclick="location.href='controlador.php?action=carga_capacitacion'" id="addRow" class="btn btn-success"><i class="icon-plus"></i> Cargar una nueva Capacitacion</button>
</div>
...
<script type="text/javascript">
    newSuggestFiltroCapacitaciones('persona', 'personaID', 'P');
    newSuggestFiltroCapacitaciones('poe', 'poeID', 'Po');
</script>
</body>
</html>
