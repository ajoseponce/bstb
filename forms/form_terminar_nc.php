    ...
    <div class="block block-themed block-last">
        <form id="form_datos" method="post" class="form-horizontal">
            ...
            <div class="block-content">
                ...
                <div class="control-group">
                    <div class="control-group" id="sector_capa">
                        <label class="control-label" for="general-text">Accion</label>

                        <div class="controls">
                            <select id="accion" name="accion">
                                <option value="C">Cerrar</option>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <textarea id="observaciones" style="width: 773px; height: 78px;" name="observaciones"
                                  value=""><?php echo ($result->observaciones) ? $result->observaciones : ""; ?> </textarea>
                    </div>
                </div>
            </div>

            <div class="form-actions">
                <input id="action" type="hidden" name="action" value="guardar_terminar_nc">
