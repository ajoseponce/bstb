<?php  
 ...
 class Api extends Rest {  
   const servidor = "10.1.2.30";  
   const usuario_db = "s_bstb";  
   const pwd_db = "Eub2FpEG6E6X";  
   const nombre_db = "ango_personas";  
   private $_conn = NULL;  
   private $_metodo;  
   private $_argumentos;  
   ...
   private function personas() {  
     ...
     $dni_persona = $this->datosPeticion['dni_persona'];
     $query="SELECT d.id_persona, d.nombre, d.apellido, pf.numero_documento, d.sexo, d.fecha_nacimiento, d.domicilio, d.telefono_celular, d.mail, l.descripcion localidad_texto, d.codigo_postal FROM dominio_interno d
     INNER JOIN persona_federacion_dominio pd ON pd.id_persona=d.id_persona 
     INNER JOIN localidad l ON l.cod_localidad=d.localidad 
     INNER JOIN persona_federacion pf ON pf.id_persona_federada=pd.id_persona_federada 
      WHERE pf.numero_documento='".$dni_persona."' ";
     //echo  $query;
